...
const addressData = [
  ...
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "hariharasudhan.p0110@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+91 7092973952",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                Have a question, opportunity, or collaboration in mind? Share
                your details and message, and I will get back to you.
              </p>
            </div>
