...
const Form = () => {
  const recipientEmail = "yourmail@example.com";
  ...
  const handleSubmit = (event) => {
    ...
    setStatus({
      type: "success",
      text: "Opening your default email app with pre-filled details.",
    });
  };
  ...
  return (
    <div>
      <p className="text-[12px] xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-soft-dark">
        Fill in your basic details and message. On submit, your email app will
      ...
      <div className="mx-2">
        <form className="flex flex-col gap-4 mt-4" onSubmit={handleSubmit}>
          ...
          <textarea
            name="message"
            placeholder="Message*"
            className={`${commonClass} resize-none min-h-24`}
